...
void fillAndRandomizeQList() {
	...
	MainQuestionList.push_back(new Question("Lock: 4 letter Lock (Metal Lock). \nQuestion: \nMr. Harriz is suspected of having mastered teleportation. He begins at a point (5,3) on p(x). He then suddenly appears at a point on 2p[-5(x-1)]+1. Find the y-coordinate of this new transformed point.", "7", "The value of your solution (7) is the position of the character in the alphabet that is the first letter of the combination"));
	MainQuestionList.push_back(new Question("Lock: 4 letter lock (Metal Lock). \nQuestion: \nMr Harriz’s net income  can be modelled by relating his annual llama expenses to his llama renting business profits. It is modelled by the function I(x)= -(x-3000)(x+1). There was a year when the IRoC was approximately -1025. Determine which year it was.", "2012", "The last two digits of your solution (2012) indicate the alphabetical position of the second letter of the combination"));
	MainQuestionList.push_back(new Question("Lock: 4 letter lock (Metal Lock). \nQuestion: \nThere is a defensive wall that surrounds Mr. Harriz’s house. In order to climb over it, you need a ladder between 5 and 7 metres long. The inequality |x-a| <b represents this scenario, where xrepresents the length of the ladder. Let c=a+b. Find the value of c.", "7", "Your value of c (7) is the alphabetic position of the third letter in the combination."));
