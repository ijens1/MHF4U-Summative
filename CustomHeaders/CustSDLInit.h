...
void fillAndRandomizeQList() {
	...
	MainQuestionList.push_back(new Question("Lock: Directional Lock (Purple Lock). \nQuestion: \nMr. Harriz has a certain security barrier that involves matching two sides of an equation. Which expression is equal to f(x)? (look at visuals window to see the function definition and the options)", "2", "Your solution (2) gives the fourth and final direction (1: up, 2: down, 3: right,  4: left)", new Image(loadPath("Images/johnQ3.png"), MainRenderer, 0, 0, SCREEN_WIDTH, 268)));
