...
void fillAndRandomizeQList() {
    ...
    MainQuestionList.push_back(new Question("Lock: Spinny Lock. \nQuestion: \nMr Harriz\'s llama population can be modelled by the function f(t) where t is the time in years since he started the farm. However once the population reached 100,000 llamas Mr. Harriz ran out of space and had to start selling off llamas. This caused a large increase in profits and thus allowed for a large increase in his criminal activities. In how many years after he started the farm did this occur(rounded to the nearest integer)?", "48", "Your answer (48) is the first number in the combination", new Image(loadPath("Images/benQ1.png"), MainRenderer, 0, 0, SCREEN_WIDTH, 89)));
    MainQuestionList.push_back(new Question("Lock: Spinny Lock. \nQuestion: \nMr Harriz finds earthquakes very annoying as they always seem to kill off his llamas. Because of this he keeps detailed records of earthquakes. Hidden in the room is a graph of all the earthquakes he has tracked. How many times more intense is the largest earthquake than the second largest(rounded to the nearest integer)? When analyzing the graph, take measurements rounded to the nearest 0.5.", "32", "Your solution (32) is the second number in the combination", new Image(loadPath("Images/benQ2.png"), MainRenderer, 0, 0, SCREEN_WIDTH, 242)));
    MainQuestionList.push_back(new Question("Lock: Spinny Lock. \nQuestion: \nIn order to break into Mr. Harriz\'s safe you need to corrode the lock with an acid with a pH of 4.37. However all of your vials of acid are only labelled with concentrations of hydrogen ions. Enter the concentration that you should use multiplied by (10)^(6) rounded to the nearest integer.", "43", "Your final answer (43) is the third number for the lock.", new Image(loadPath("Images/benQ3.png"), MainRenderer, 0, 0, SCREEN_WIDTH, 151)));
    
	//TRIGONOMETRY
	MainQuestionList.push_back(new Question("Lock: Directional Lock (Purple Lock). \nQuestion: \nMr. Harriz has heard of the story of Icarus and knows that he shouldn\'t fly too close to the sun when using his hang glider to survey his llama farm. His altitude will be given by f(t), with f(t) in metres and t in seconds from the time he jumps out of the hot air balloon (there is lots of wind). To find the value of B, find the crossword puzzle on the wall and follow the instructions below it. If at 1204m and above his hang glider will deteriorate, and the hang glider can only sustain 31s of this deterioration until it breaks, how many seconds does Mr. Harriz have until his hang glider breaks?", "139", "The largest digit in your answer (139) gives the first direction (1: up, 3: down, 6: right, 9: left). The middle digit gives the second direction (2: up, 3: down, 5: right, 7: left).", new Image(loadPath("Images/johnQ1.png"), MainRenderer, 0, 0, SCREEN_WIDTH, 102)));
	...
	MainQuestionList.push_back(new Question("Lock: Directional Lock (Purple Lock). \nQuestion: \nMr. Harriz has a certain security barrier that involves matching two sides of an equation. Which expression is equal to f(x)?", "2", "Your solution (2) gives the fourth and final direction (1: up, 2: down, 3: right,  4: left)", new Image(loadPath("Images/johnQ3.png"), MainRenderer, 0, 0, SCREEN_WIDTH, 268)));
